"""
Flask web app for video editor - EXP-012.
Feature: Separate volume controls for Speech and Music tracks.
"""
import os
import uuid
...
def preview_full():
    ...
    # EXP-012: Separate volume controls
    ...
    if audio:
        ...
        if audio_path.exists():
            ...
            audio_track = AudioTrackSpec(
                path=audio_path,
                volume=music_volume,  # EXP-012: Use music_volume
    ...
    try:
        ...
        concat_videos(
            ...
            speech_volume=speech_volume,  # EXP-012: Pass speech volume
            resolution=(854, 480)
        )
...
if __name__ == '__main__':
    print("=" * 50)
    print("Video Editor - EXP-012 Volume Controls")
    print("=" * 50)
    print(f"Upload: {UPLOAD_DIR}")
    print(f"Output: {OUTPUT_DIR}")
    print(f"Preview: {PREVIEW_DIR}")
    print()
    print("Features in EXP-012:")
    print("  - Separate Speech Volume control (0-200%)")
    print("  - Separate Music Volume control (0-200%)")
    print()
    print("Open: http://localhost:5019")
    print("=" * 50)
