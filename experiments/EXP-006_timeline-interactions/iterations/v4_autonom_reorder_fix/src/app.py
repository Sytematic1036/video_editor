"""
Flask web app for video editor with trim handles.
EXP-005 v3: Added Preview Full button.
"""
import os
import uuid
...
from concat import VideoClipSpec, CrossfadeSpec, AudioTrackSpec, concat_videos, ffprobe_duration_seconds
...
def preview_full():
    ...
    try:
        ...
        concat_videos(video_clips, preview_path, crossfade=crossfade, audio_track=audio_track, resolution=(854, 480))
...
def export_video():
    ...
    try:
        concat_videos(video_clips, output_path, crossfade=crossfade, audio_track=audio_track, resolution=(1920, 1080))
    except Exception as e:
        return jsonify({'error': str(e)}), 500
...
if __name__ == '__main__':
    print("=" * 50)
    print("Video Editor v6.3 - HTML5 Drag & Drop (v4)")
    print("=" * 50)
    print(f"Upload: {UPLOAD_DIR}")
    print(f"Output: {OUTPUT_DIR}")
    print(f"Preview: {PREVIEW_DIR}")
    print()
    print("Features: Clickable timeline, Draggable playhead,")
    print("          Reorder clips (HTML5 D&D), Auto-fit audio")
    print()
