...
EXP-018: Merged from EXP-016 (video_editor) and EXP-017 (html-to-mp4)
...
# ============================================================
# VIDEO EDITOR ROUTES (from EXP-016)
# ============================================================
...
def download_export(filename):
    ...
    # Check exports first, then output
...
def storage_info():
    ...
    return jsonify({
        ...
        'html_uploads_mb': round(dir_size(HTML_DIR) / (1024 * 1024), 2),
...
if __name__ == '__main__':
    print("=" * 60)
    print("Video Editor + HTML to MP4 - EXP-018 Merged")
    print("=" * 60)
