"""
Flask web app for video editor - EXP-013.
Feature: Robust export system with progress tracking and download.

New endpoints:
- /export - Start final export (returns job_id)
- /export-status/<job_id> - Get export progress
...
def start_export():
    ...
    if not videos:
        return jsonify({'error': 'No videos to export'}), 400
...
if __name__ == '__main__':
    print("=" * 50)
    print("Video Editor - EXP-013 Export System")
    print("=" * 50)
    ...
    print()
    print("Features in EXP-013:")
    print("  - Export to full HD (1920x1080)")
    print("  - Progress tracking via /export-status")
    print("  - Download exported files")
    print("  - Cleanup old temporary files")
    print()
    print("Open: http://localhost:5020")
    print("=" * 50)
