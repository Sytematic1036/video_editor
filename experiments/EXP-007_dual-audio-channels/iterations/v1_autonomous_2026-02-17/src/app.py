"""
Flask web app for video editor with dual audio channels.
EXP-007: Speech track + Music track with silence insertion.
"""
import os
import uuid
...
if __name__ == '__main__':
    print("=" * 50)
    print("Video Editor - EXP-007 Dual Audio")
    print("=" * 50)
    ...
    print()
    print("Features:")
    print("  - Speech Track (voiceover)")
    print("  - Music Track (background)")
    print("  - Insert Silence (right-click)")
    print("  - Drag clips to reorder")
    print()
