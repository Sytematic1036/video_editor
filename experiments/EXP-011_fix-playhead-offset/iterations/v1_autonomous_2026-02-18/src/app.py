"""
Flask web app for video editor - EXP-011.
Fixes: Double playhead bug + offset on split/insert.
"""
import os
import uuid
...
if __name__ == '__main__':
    print("=" * 50)
    print("Video Editor - EXP-011 Fix Playhead & Offset")
    print("=" * 50)
    print(f"Upload: {UPLOAD_DIR}")
    print(f"Output: {OUTPUT_DIR}")
    print(f"Preview: {PREVIEW_DIR}")
    print()
    print("Fixes in EXP-011:")
    print("  - Removed double playhead bug")
    print("  - Fixed offset on split/insert (now exact)")
    print()
    print("Open: http://localhost:5018")
    print("=" * 50)
