"""
Flask web app for video editor with enhanced playhead.
EXP-009: Global playhead spanning all tracks with right-click context menu.
"""
import os
import uuid
...
if __name__ == '__main__':
    print("=" * 50)
    print("Video Editor - EXP-009 Enhanced Playhead")
    print("=" * 50)
    ...
    print()
    print("Features:")
    print("  - Global playhead spanning all tracks")
    print("  - Playhead draggable to max duration")
    print("  - Right-click playhead: Insert Silence / Split Clip")
    print()
    print("Open: http://localhost:5016")
    print("=" * 50)
